...
class ScheduleController extends Controller
{
    ...
    */
     ...
     *
     * Un étudiant reçoit :
     * - les horaires généraux (promotion_id = NULL)
     * - les horaires spécifiques à sa promotion
     */
    public function indexCourses(Request $request)
    {
        try {
            $schedules = $this->scheduleService->getSchedulesFor(
                $request->user(),
     ...
     */
    public function storeCourse(StoreScheduleRequest $request)
    {
        try {
    ...
    */
     ...
     */
    public function storeExam(StoreScheduleRequest $request)
    {
        try {
            $this->authorize('create', Schedule::class);
